...
print(f"Using eval seed: {eval_seed}")

# Recreate env and load normalization stats
base_env = DummyVecEnv([make_env(eval_seed)])
eval_env = VecNormalize.load(NORM_PATH, base_env)
...
while not done and step_count < max_steps:
    ...
    print(
        f"Step {step_count:03d} | SOC: {soc:.3f} | Temp: {temp:.2f} | trem: {trem:.3f} hrs | "
